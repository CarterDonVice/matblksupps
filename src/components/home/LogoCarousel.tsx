...
export function LogoCarousel() {
  ...
  return (
    <div className="w-full h-[300px] overflow-x-hidden py-4 bg-transparent relative flex items-center">
      ...
      <div className="flex animate-scroll">
        {[...logos, ...logos].map((src, index) => (
          <div key={index} className="flex-shrink-0 mx-6" style={{ width: '300px' }}>
            <Image
              src={src}
              alt="MAT BLK Logo"
              width={300}
