...
export function FeaturedProduct({ product }: FeaturedProductProps) {
  ...
  return (
    <div className="relative bg-background overflow-hidden">
        ...
        <section className="pt-12 pb-16 md:py-24 bg-transparent relative z-10">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid md:grid-cols-2 gap-10 lg:gap-16 items-start bg-black/10 backdrop-blur-sm border border-white/20 p-6 rounded-lg">
                    ...
                    <div className="space-y-6">
                      <h1 className="font-headline font-bold">
                          ...
                          <div className="flex items-center rounded-md border border-input">
                              <Button variant="outline" size="icon" onClick={decreaseQuantity} className="h-10 w-10 rounded-r-none bg-transparent border-none">
                              <Minus className="h-4 w-4" />
                              </Button>
                              <span className="px-4 w-12 text-center font-medium">{quantity}</span>
                              <Button variant="outline" size="icon" onClick={increaseQuantity} className="h-10 w-10 rounded-l-none bg-transparent border-none">
