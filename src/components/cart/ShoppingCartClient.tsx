    ...
    <div className="grid lg:grid-cols-3 gap-12 items-start">
      <div className="lg:col-span-2 space-y-6">
        <div className="flex justify-between items-center pb-4 border-b border-border">
            ...
            {cartItems.length > 0 && (
                <Button variant="outline" size="sm" onClick={clearCart} className="text-destructive hover:bg-destructive hover:text-destructive-foreground border-destructive">
      ...
      <div className="lg:col-span-1 p-6 bg-card rounded-lg shadow-lg border border-border/50 sticky top-28">
        ...
        <div className="space-y-3 mb-6">
          ...
          {/* Add more summary lines if needed, e.g., tax */}
        </div>
