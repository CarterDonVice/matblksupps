...
const scienceData: IngredientCategory[] = [
  {
    title: "Carbs",
    ingredients: [
      { name: "Isomaltulose", summary: "A slow-digesting, low-glycemic carbohydrate derived from beet sugar, Isomaltulose provides sustained blood glucose and energy release. It prevents sharp insulin spikes and crashes, supporting endurance-based performance. It’s included in pre‑workouts to supply long-lasting fuel without gastrointestinal upset." },
    ]
  },
  {
    ...
    ingredients: [
      ...
      { name: "Inositol-Stabilized Arginine Silicate", summary: "A patented complex of arginine and inositol-stabilized silicate, Inositol-Stabilized Arginine Silicate increases nitric oxide within 15–30 minutes. This enhances blood flow, cognitive clarity, and focus during training. It’s clinically dosed in pre‑workouts to support pump and mental acuity." },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: "Citicoline", summary: "Citicoline is an efficient choline source that supports brain energy metabolism, increasing attention span, reaction speed, and visual processing. It enhances cognitive and athletic performance simultaneously. It’s included for multi-domain neuro-performance support." }
    ]
  },
  {
