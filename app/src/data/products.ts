...
export const products: Product[] = [
  {
    ...
    ingredients: [
      ...
      'Dicaffeine Malate – 133 mg (yields ~100 mg caffeine)',
  ...
  },
  {
    ...
    ingredients: ['L-Citrulline', 'Glycerol Powder (65%)', 'Inositol-Stabilized Arginine Silicate', 'Lion\'s Mane Mushroom', 'Huperzine A'],
  },
  {
    id: '7',
    ...
    ingredients: ['L-Citrulline Malate 2:1', 'Glycerol Powder (65%)', 'Agmatine Sulfate', 'Inositol-Stabilized Arginine Silicate', 'Himalayan Pink Salt'],
  },
  {
    id: '4',
    ...
    ingredients: ['Creatine Monohydrate', 'Creatine HCl', 'Magnesium Creatine Chelate', 'Betaine Anhydrous', 'Astragalus and Panax Notoginseng Extract'],
  },
  {
    id: '5',
